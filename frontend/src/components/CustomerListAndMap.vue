  ...
  <div class="p-4 bg-white rounded-lg shadow-md">
    ...
    <div class="border rounded-lg overflow-hidden">
      ...
      <div v-if="activeView === 'list'" class="bg-yellow-50">
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-yellow-100">
              <tr>
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider cursor-pointer" @click="sortData('name')">
                  Name
                  <span v-if="sortBy === 'name'" class="ml-1">
                    <svg v-if="sortOrder === 'asc'" class="inline w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                    <svg v-else class="inline w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider cursor-pointer" @click="sortData('type')">
                  Type
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider cursor-pointer" @click="sortData('province')">
                  Province
                  <span v-if="sortBy === 'province'" class="ml-1">
                    <svg v-if="sortOrder === 'asc'" class="inline w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                    <svg v-else class="inline w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="(customer, index) in filteredAndSortedCustomers" :key="index" class="hover:bg-yellow-50 transition-colors">
        ...
        <!-- Empty state -->
        <div v-if="filteredAndSortedCustomers.length === 0" class="py-10 text-center text-gray-500">
      ...
      <div v-else class="relative h-[600px] bg-green-50">
        ...
        <div v-if="selectedProvince" class="absolute top-4 right-4 bg-white p-3 rounded-lg shadow-lg">
          <p class="text-sm font-medium text-gray-800">Selected: {{ selectedProvince }}</p>
        </div>
      </div>
    </div>
  </div>
...
const customers = ref<Customer[]>([
  { id: 1, name: 'HUN Sopheak', telephone: '0127894455', type: 'Distributor', province: 'Banteay Meanchey' },
  { id: 2, name: 'NGEAN Tina', telephone: '097632541', type: 'Pagoda', province: 'Phnom Penh' },
  { id: 3, name: 'HUON Sopanha', telephone: '0979654123', type: 'Event', province: 'Phnom Penh' },
  { id: 4, name: 'HUON Sopanha', telephone: '0979654123', type: 'Home', province: 'Phnom Penh' },
  { id: 5, name: 'HUON Sopanha', telephone: '0979654123', type: 'Event', province: 'Phnom Penh' },
  { id: 6, name: 'HUON Sopanha', telephone: '0979654123', type: 'Event', province: 'Phnom Penh' },
  { id: 7, name: 'HUON Sopanha', telephone: '0979654123', type: 'Event', province: 'Phnom Penh' },
  { id: 8, name: 'HUON Sopanha', telephone: '0979654123', type: 'Event', province: 'Phnom Penh' },
  { id: 9, name: 'HUON Sopanha', telephone: '0979654123', type: 'Event', province: 'Phnom Penh' }
]);
